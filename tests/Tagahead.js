/* =============================================================
 * bootstrap-tagahead.js v2.0.0
 * http://twitter.github.com/bootstrap/javascript.html#tagahead
 * =============================================================
...
!function( $ ){
  ...
  * ================================= */
  ...
  /* TagAHEAD PLUGIN DEFINITION
   * =========================== */

  $.fn.tagahead = function ( option ) {
    return this.each(function () {
      var $this = $(this)
        , data = $this.data('tagahead')
        , options = typeof option == 'object' && option
      if (!data) $this.data('tagahead', (data = new Tagahead(this, options)))
      if (typeof option == 'string') data[option]()
    })
  }

  $.fn.tagahead.defaults = {
    source: []
  , items: 8
  , menu: '<ul class="tagahead dropdown-menu"></ul>'
  , item: '<li><a href="#"></a></li>'
  , delimiter: ','
  , mode: 'single'
  }
  ...
  * ================== */
  ...
  $(function () {
    $('body').on('focus.tagahead.data-api', '[data-provide="tagahead"]', function (e) {
      var $this = $(this)
      if ($this.data('tagahead')) return
      e.preventDefault()
      $this.tagahead($this.data())
    })
  })
